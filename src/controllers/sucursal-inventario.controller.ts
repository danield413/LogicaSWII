...
export class SucursalInventarioController {
  ...
  @get('/sucursals/{id}/inventarios', {
    responses: {
      '200': {
        description: 'Array of Sucursal has many Inventario',
        content: {
          'application/json': {
  ...
  @patch('/sucursals/{id}/inventarios', {
    responses: {
      '200': {
